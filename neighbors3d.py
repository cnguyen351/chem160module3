...
#Fraction with more than 2 neighbors: 0.6565712550461131
#Theoretical is 0.65626
#Actual result is slight higher than the theoretical.
#Essentially both results are the same.